...
@Component({
  ...
  styleUrls: ['./edit-costo.component.scss']
})
export class EditCostoComponent {
code: any;
  isLoading$: any;
  ...
  ngOnInit(): void {
    ...
    this.costosService.showCosto(this.COSTO_ID).subscribe((resp: any) => {
      ...
      this.type_discount = resp.costo.type_discount;
      this.discount = resp.costo.discount;
      this.type_count = resp.costo.type_count;
      this.num_use = resp.costo.num_use;
      this.type_costo = resp.costo.type_costo;
      this.state = resp.costo.state;

      // Remove duplicates from products based on product id
      const uniqueProducts = [];
      const productIds = new Set();

      for (const product of resp.costo.products) {
      ...
      this.categories_add = resp.costo.categories;
      this.brands_add = resp.costo.brands;
    });
  }
